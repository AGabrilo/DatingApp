...
namespace API.Data.Migrations
{
    ...
    [Migration("20210609081412_RatingEntityAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.Rating", b =>
                {
                    ...
                    b.HasKey("RatingUserId", "RatedUserId");
            ...
            modelBuilder.Entity("API.Entities.Rating", b =>
                {
                    b.HasOne("API.Entities.AppUser", "RatedUser")
                        .WithMany("RatedByUsers")
                        .HasForeignKey("RatedUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API.Entities.AppUser", "RatingUser")
                        .WithMany("RatedUsers")
